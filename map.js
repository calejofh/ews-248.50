...
// =============================
// Layer 1: Barrios afectados (MultiPolygon) - CORREGIDO
// =============================
var barriosAfectados = {
  ...
  "features": [
    {
      "type": "Feature",
      "properties": { "Layer": "BARRIO 24 DE MAYO", "Area_Ha": 23.9 },
      "geometry": {
        "type": "MultiPolygon",
        "coordinates": [
          [
            [
              ...
              [-76.988954959687376, -0.467564335349018]  // cierre del anillo
            ]
          ]
        ]
      }
    ...
    {
      "type": "Feature",
      "properties": { "Layer": "BARRIO 30 DE ABRIL", "Area_Ha": 21.6 },
      "geometry": {
        "type": "MultiPolygon",
        "coordinates": [
          [
            [
              ...
              [-76.990288215743931, -0.477074744513631],
              [-76.990288215743931, -0.477074744513631]  // cierre del anillo
            ]
          ]
        ]
      }
  ...
  onEachFeature: function (feature, layer) {
    if (feature.properties && feature.properties.Layer) {
      layer.bindPopup("<b>" + feature.properties.Layer + "</b>"
        + (feature.properties.Area_Ha ? "<br>Área: " + feature.properties.Area_Ha + " Ha" : ""));
    }
  }
}).addTo(map);
